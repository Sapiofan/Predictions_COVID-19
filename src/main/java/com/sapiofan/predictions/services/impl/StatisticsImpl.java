...
//                        if(stringIntegerEntry.getKey().equals("World")) {
...
//                }
//
//                Map<String, Integer> init = new TreeMap<>(data.dateComparator());
//                Map<String, Integer> prediction = new TreeMap<>(data.dateComparator());
//                counter = 1;
//                for (Map.Entry<String, Integer> stringIntegerEntry : map2.entrySet()) {
//                    init.put(stringIntegerEntry.getKey(), counter++);
//                }
//
//                for (int i = 57; i <= 74; i++) {
////                    prediction.put()
